...
if (isset($_SESSION['user_lrn'])) {
    ...
    $sqlCheck = "SELECT COUNT(*) AS count FROM `stage1_level2` WHERE `LRN` = ?";
    ...
    if ($row['count'] == 0) {
        ...
        $sqlInsert = "INSERT INTO `stage1_level2` (`LRN`, `PART1`, `PART2`, `PART3`, `PART4`) VALUES (?, 0, 0, 0, 0)";
